...
class BaseTests(TestCase):
    ...
    def test_telegram_init(self):
        telegram_object = Telegram("my_totally_real_telegram_token:now_with_colon")
        self.assertEqual(telegram_object.bot.token, "my_totally_real_telegram_token:now_with_colon")

    def test_telegram_send_alert(self):
        with requests_mock.Mocker() as request_mocker:
            request_mocker.post('https://api.telegram.org/botmy_totally_real_telegram_token:now_with_colon/sendMessage?chat_id=123&'
